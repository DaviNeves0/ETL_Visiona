...
public class InputServices {
	...
	public static String insertShpToDbt(List<String> dbtColNames, List<String> selectedColumns, String shpFileName,
		...
		String parametrizar = writeSqlExtract(dbtColNames, selectedColumns);
	...
	public static String writeSqlExtract(List<String> dbtColNames, List<String> selectedColumns) {
